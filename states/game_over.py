...
class GameOver(BaseState):
    def __init__(self):
        ...
        self.title = self.font.render("Game Over", True, pygame.Color("BLACK"))
        self.title_rect = self.title.get_rect(center=self.screen_rect.center)
        self.instructions = self.font.render("Press space to start again, or enter to go to the menu", True,
                                             pygame.Color("BLUE"))
